    ...
    <div className="min-h-screen bg-[#36393f] text-white overflow-x-hidden">
      ...
      <nav className="bg-[#2f3136] border-b border-[#202225] px-4 sm:px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              <h1 className="text-lg sm:text-xl font-bold text-white">Kazangram</h1>
              <p className="text-xs text-[#b9bbbe] hidden sm:block">Социальная сеть Казани</p>
            </div>
          </div>
      ...
      {showForm && (
        <div
          ...
          onClick={(e) => { if (e.target === e.currentTarget) { setShowForm(false); setSuccess(false); setError(""); } }}
        >
          <div className="bg-[#36393f] rounded-xl w-full max-w-md p-6 sm:p-8 relative shadow-2xl">
            <button
              ...
              onClick={() => { setShowForm(false); setSuccess(false); setError(""); }}
            >
              <X className="w-5 h-5" />
            </button>
